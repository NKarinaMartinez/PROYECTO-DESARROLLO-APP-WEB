...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2023 a las 04:40:15
...
INSERT INTO `boleto` (`bol_id`, `bol_nombre`, `bol_precio`, `bol_estado`, `bol_idCategoria`, `bol_descripcion`, `bol_usuarioActualizacion`, `bol_fechaActualizacion`) VALUES
(1, 'Campamento Vacacional Extremo', 29.99, 1, 1, 'Experiencia emocionante de aventura y diversión en la naturaleza, ideal para jóvenes aventureros.', 'usuario', '2023-03-06 03:36:13'),
(2, 'Huasquila Amazon Lodge - Napo', 35.99, 1, 2, 'Eco-lodge sostenible en la selva amazónica con actividades únicas y alojamiento cómodo y acogedor.', 'usuario', '2023-03-07 21:45:13'),
(3, 'Buceo Extremo', 20.8, 1, 2, 'Los mejores sitios de buceo en la Isla Santa Cruz son bahía de Puerto Ayora.', 'usuario', '2023-03-08 23:53:47'),
(4, 'Quito Cultural 3D-2N', 40, 1, 2, 'Quito Cultural 3D-2N', 'usuario', '2023-03-09 02:08:27'),
(5, 'Florecimiento de Guayacanes', 15.99, 1, 2, 'Florecimiento de Guayacanes', 'usuario', '2023-03-09 02:08:27');
...
(2, 'Andrea', 'Andrea1', 'Andrea1', 2),
(3, 'Dario', 'Dario1', 'Dario1', 3);
